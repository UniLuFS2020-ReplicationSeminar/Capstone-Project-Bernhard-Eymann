...
ds_grosserrat_complete <- read.csv("data/ds_grosserrat_complete_all.csv")
ds_grosserrat_complete <- ds_grosserrat_complete[1]

# saving the extracted column to a new csv
write.csv(ds_grosserrat_complete, "data/ds_grosserrat_complete.csv")
x <- read.csv("data/ds_grosserrat_complete_all.csv")
